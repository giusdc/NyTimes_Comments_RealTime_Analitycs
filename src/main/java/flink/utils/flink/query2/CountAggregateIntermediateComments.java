...
public class CountAggregateIntermediateComments implements AggregateFunction<Tuple3<String,Integer,Long>,Tuple2<String,Integer>, Tuple2<String,Integer>> {
    @Override
    ...
    @Override
    public Tuple2<String, Integer> add(Tuple3<String, Integer, Long> tuple, Tuple2<String, Integer> aggr) {
